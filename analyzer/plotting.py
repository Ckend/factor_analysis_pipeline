...
Date: 2023-12-27 22:48:23
LastEditors: hugo2046 shen.lan123@gmail.com
LastEditTime: 2024-01-04 10:13:06
FilePath: 
Description: 
'''
# -*- coding: utf-8 -*-
...
def plot_tstat_table(ttest_data: pd.DataFrame):
    ...
    print("T-stat 分析")
    print_table(ttest_summary_table.apply(lambda x: x.round(3)).T)
