...
from data_service import DolinphdbLoader, Loader, CSVLoder
...
#     st.session_state["price_type"] = "Adj Close"
#     print(st.session_state["price_type"])
...
with st.container():
    ...
    loader: Loader = CSVLoder(price_path="data/price.csv", factor_path="data/factor.csv")
